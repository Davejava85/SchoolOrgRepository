...
public class StudentiControllerTest {
    ...
    public void setUp() {
        ...
        studente.setId(1);
        studente.setNome("John");
        studente.setEmail("john.doe@example.com");
        studente.setCognome("rambo");
...
//        when(studentiService.findStudentByEmail("john.doe@example.com")).thenReturn(studentiDTO);
        ...
        mockMvc.perform(get("/api/student/{email}", "john.doe@example.com"))
                ...
                .andExpect(jsonPath("$.cognome").value("rambo"))
                .andExpect(jsonPath("$.password").value("123456"))
                .andExpect(jsonPath("$.ruolo").value("studente"));
