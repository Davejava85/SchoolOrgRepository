...
class SchoolOrgApplicationTests {
    ...
    void testFindStudentByLetter_Success() {
        ...
        List<Studenti> mockStudents = List.of(
                new Studenti(1, "Giovanni", "Rossi", "giovanni.rossi@example.com", "123456", "studente"),
                new Studenti(2, "Giorgia", "Bianchi", "giorgia.bianchi@example.com","12345678" , "studente" ),
                new Studenti(3, "Mario", "Verdi", "mario.verdi@example.com" ,"12345679" , "studente")
        );
        ...
        List<StudentiDTO> mockStudentDTOs = List.of(
                new StudentiDTO(1, "Giovanni", "Rossi", "giovanni.rossi@example.com","123456", "studente"),
                new StudentiDTO(2, "Giorgia", "Bianchi", "giorgia.bianchi@example.com","12345678" , "studente")
        );
